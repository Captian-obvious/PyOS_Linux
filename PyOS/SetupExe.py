...
def create_login_page(root):
    ...
    ui_theme.configure('TEntry',background='#333',foreground='#fff',fieldbackground='#333',border="#fff");
    ...
    def next_btn_fn():
        ...
        usr={
            ...
            "root":False,
            "prof_pic":["PyOS/assets/images/default_person.svg",True],
            "desktop":["PyOS/assets/backgrounds/background.png",True],
            "privs":{
                "debug":False,
            },
        };
...
def load_ui():
    ...
    common.create_bg_img(mainwin,root,'PyOS/assets/backgrounds/background.png');
