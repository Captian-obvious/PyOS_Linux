...
def install(config):
    ...
    #oldlen=5.2;
    #oldsize=96;
    BootSpinner=BootupSpinner(mainwin,canvas_size=64,animation_length=3.2,arc_width=3,arc_color=("#fff","#fff"),bg_color="#aaa");
    BootSpinner.place(relx=.5,rely=.8,anchor=ui.CENTER);
    mainwin.update();
    ...
    if mainwin.winfo_screenheight()<480:
        InstallImage.place(relx=.5,rely=.4,anchor=ui.CENTER);
    else:
