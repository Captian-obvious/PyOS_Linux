...
def load():
    ...
    if (for_install==True):
        ...
        uiw.print_info("Live Boot Detected. Running Installer...");
...
def authorize(main,cfg,callback):
    ...
    mainstyle.configure('TEntry',background='#333',foreground='#fff',fieldbackground='#333',border="#fff",insertbackground="#fff");
    def draw_usr(i):
        global texts,cur;
        cur=i-1;
        root.delete(*texts);
